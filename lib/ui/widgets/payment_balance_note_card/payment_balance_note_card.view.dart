...
class PaymentBalanceNoteCard extends StatelessWidget {
  final BalanceNotes balanceNote;
  final String patientID;
  const PaymentBalanceNoteCard(
      {Key? key, required this.balanceNote, required this.patientID})
      : super(key: key);
                    ...
                    children: [
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text: DateFormat.yMd()
                                        .add_jm()
                                        .format(balanceNote.date.toDateTime()!),
                                    style:
                      ...
                      RichText(
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text: balanceNote.balance.toCurrency,
                                    style: TextStyle(
